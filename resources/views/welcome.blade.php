...
@section('content')
    <div class="container">
        <div class="row ">
            <p class="my-5 text-center display-2">Welcome to myasset.</p>
            <p class="my-5"></p>
        </div>
        ...
        <div class="d-flex justify-content-center">
            <div class="row d-flex justify-content-center">
                <svg style="width: fit-content" height="400px" width="400px" xmlns="http://www.w3.org/2000/svg"
                     viewBox="0 0 500 500">
                ...
                <p  class=" mt-4 text-center fs-2">One place to store and balance your portfolio</p>
            </div>
        </div>
